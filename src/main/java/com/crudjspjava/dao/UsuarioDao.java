...
public class UsuarioDao {
	...
	//	OBTENDO REGISTROS ESPECIFICOS DE ACORDO COM O ID 
	public static Usuario getRegistroById(int id) {
		...
		try {
			...
			while (rs.next()) {
				usuario = new Usuario(); 
				// OS PARÂMETROS PASSADOS NO .get DEVEM CORRESPONDER AOS CAMPOS DO BANCO
	...
	// REALIZANDO EDIÇÃO NOS CAMPOS DA TABELA
	...
	// OBTENDO OS VALORES DOS CAMPOS DA TABELA 
